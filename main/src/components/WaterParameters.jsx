...
function WaterParameters() {
  ...
  return (
    <div className="w-full min-h-[clamp(600px,90vh,800px)]   sm:[@media(min-width:800px)]:h-[2000px] md:h-[2000px] md:min-h-[400px] flex flex-col lg:flex-row overflow-x-auto overflow-y-auto lg:overflow-x-hidden gap-4 p-4">
      {/* Sensor Data Section */}
      ...
      <section
        className="flex-1 flex flex-col items-center justify-between w-full lg:w-[60%] min-w-[280px] min-h-[400px] lg:min-w-0 bg-[#edeae49f] rounded-xl shadow-md p-4 h-[clamp(500px,80vh,800px)] overflow-y-auto"
        ref={chartFocus}
      >
